...
parser.add_argument('--use-n2v-embedding', action='store_true', default=False,
                    help='whether to use node2vec node embeddings')
parser.add_argument('--use-cane-embedding', action='store_true', default=False,
                    help='whether to use cane node embeddings')
...
if args.use_cane_embedding:
    embeddings = generate_CANE_embeddings(A, text)
if args.use_n2v_embedding:
...
if args.only_predict:
    ...
    recall5 = calc_recall(pred_name, 0.5)
    print('The recall for treshold at 0.5:', recall5)
    recall7 = calc_recall(pred_name, 0.7)
    print('The recall for treshold at 0.7:', recall7)
    recall9 = calc_recall(pred_name, 0.9)
    print('The recall for treshold at 0.9:', recall9)
    exit()
